...
class BaseModel(object):
    ...
    def init_embeddings(self, hparams, scope):
        """Init embeddings."""
        self.embedding_decoder = (model_helper.create_emb_for_encoder_and_decoder(tgt_vocab_size=self.tgt_vocab_size,
        ...
        with tf.variable_scope("decoder") as decoder_scope:
            ...
            ## Inference
                ...
                if beam_width > 0:
                    ...
                    # Decoder
                    my_decoder = tf.contrib.seq2seq.BasicDecoder(cell, helper, decoder_initial_state, output_layer=self.output_layer)  # applied per timestep


                # Dynamic decoding
                outputs, final_context_state, _ = tf.contrib.seq2seq.dynamic_decode(my_decoder, maximum_iterations=40, output_time_major=self.time_major, swap_memory=True, scope=decoder_scope)
...
class Model(BaseModel):
    ...
    def _build_encoder(self, hparams):
        ...
        with tf.variable_scope("encoder") as scope:
            ...
            if hparams.encoder_type == "uni":
                ...
                encoder_outputs, bi_encoder_state = (self._build_bidirectional_rnn(inputs=output,
                                                                                   sequence_length=iterator.source_sequence_length,
                                                                                   dtype=dtype,
                                                                                   hparams=hparams,
    ...
    def _build_bidirectional_rnn(self, inputs, sequence_length, dtype, hparams, num_bi_layers, num_bi_residual_layers):
        ...
        fw_cell = self._build_encoder_cell(hparams, num_bi_layers, num_bi_residual_layers)
